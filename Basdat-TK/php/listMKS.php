...
<header>
      ...
      <div class="container-fluid">
        ...
        <?php
          ...
          if($_SESSION['user_type'] == "admin"){
            echo '<li><a href="createMKS.php">Buat Jadwal Sidang MKS</a></li>';
          } 
          if($_SESSION['user_type'] == "admin" || $_SESSION['user_type'] == "dosen" ){
          echo '<li><a href="#">Buat Jadwal Non-Sidang Dosen</a></li>';
          }
          echo '<li><a href="jadwal.php">Lihat Jadwal Sidang</a></li>';
          echo '<li class="active"><a href="#">Lihat Daftar MKS</a></li>'; 
    ...
    <script src="../js/mksindex.js" type="text/javascript"></script>
</body>
</html>